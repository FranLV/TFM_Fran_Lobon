...
if __name__ == "__main__":
    ...
    if args.fixed_duration:
        ...
        start_index = event_window_iterator.get_start_index()
    else:
    ...
    with Timer('Processing entire dataset'):
        ...
        for idx in range(event_window_iterator.get_max_image_indices()):

            event_window = event_window_iterator.get_events(idx)
            ...
            # print("{}".format(time.perf_counter() - total_time))

            num_events_in_window = event_window.shape[0]
            reconstructor.update_reconstruction(event_tensor, start_index + num_events_in_window, last_timestamp, idx)
